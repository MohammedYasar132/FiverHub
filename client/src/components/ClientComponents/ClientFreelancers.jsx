...
export default function ClientServices() {
  ...
  useEffect(() => {
    dispatch(freelancersServices())
      .unwrap()
      .then((data) => {
        console.log("Fetched services:", data.allServices); // Check if services are correctly fetched
        const newAllServices = [...data.allServices];
        if (sort === "price") {
      ...
      .catch((error) => {
        ...
        toast.error("Error fetching services: " + error.message); // Show error message
                ...
                allServices.map((service) => (
                  <div key={service._id} className="service">
                    ...
                    <div className="serviceHeader">
                      ...
                      />
                      <span>
                        {service.userInfo?.username || "No username available"}
                      </span>
                    </div>
